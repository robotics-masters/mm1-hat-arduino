...
const PinDescription g_APinDescription[]=
{
  ...
  { PORTA,  20, PIO_DIGITAL, PIN_ATTR_PWM_F, No_ADC_Channel, NOT_ON_TIMER, NOT_ON_TIMER, EXTERNAL_INT_4 }, //
  { PORTA,  21, PIO_DIGITAL, PIN_ATTR_PWM_F, No_ADC_Channel, NOT_ON_TIMER, NOT_ON_TIMER, EXTERNAL_INT_5 }, //
  { PORTA, 11, PIO_DIGITAL, PIN_ATTR_PWM_F, No_ADC_Channel, TCC0_CH3, TC1_CH1, EXTERNAL_INT_11 },
  { PORTA, 10, PIO_ANALOG, (PIN_ATTR_ANALOG|PIN_ATTR_PWM_F), ADC_Channel9, TCC0_CH2, TC1_CH0, EXTERNAL_INT_10 },
  ...
  { PORTB,  9, PIO_SERCOM_ALT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_9}, // SCK: SERCOM4/PAD[1]
  { PORTB, 11, PIO_SERCOM_ALT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_11 }, // MISO: SERCOM4/PAD[3]

  // 13 (LED)
  { PORTB, 22, PIO_DIGITAL, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },  // Red LED
