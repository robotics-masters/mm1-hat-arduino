...
const PinDescription g_APinDescription[]=
{
  ...
  { PORTA,  17, PIO_SERCOM, PIN_ATTR_PWM_F, No_ADC_Channel, TCC1_CH1, TC2_CH1, EXTERNAL_INT_1 }, // SERCOM 1.1
  { PORTA,  16, PIO_SERCOM, PIN_ATTR_PWM_F, No_ADC_Channel, TCC1_CH0, TC2_CH0, EXTERNAL_INT_0 }, // SERCOM 1.0
  ...
  { PORTA, 10, PIO_DIGITAL, PIN_ATTR_PWM_F, ADC_Channel9, TCC0_CH2, TC1_CH0, EXTERNAL_INT_10 },
  { PORTA, 9, PIO_DIGITAL, PIN_ATTR_PWM_F, ADC_Channel10, TCC0_CH1, TC0_CH1, EXTERNAL_INT_9 },
  { PORTA, 8, PIO_DIGITAL, PIN_ATTR_PWM_F, ADC_Channel11, TCC0_CH0, TC0_CH0, EXTERNAL_INT_NMI },
  
  // 10..12 - SPI pins (MOSI,SCK,MOSI)
  // ----------------------
  { PORTB,  8, PIO_SERCOM_ALT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_8 }, // MOSI: SERCOM4/PAD[0]
  { PORTB, 10, PIO_SERCOM_ALT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_10 }, // SCK: SERCOM4/PAD[2]
  ...
  // 18..19 - A4..A5
  { PORTB,  23, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_7 }, // External NeoPixel
